...
define(function(require) {
	...
	$(function() {
		...
		$('#more').click(function(){
			...
			$('ul:eq(0)').attr("style","height:133px;");
		});
...
function doSearch(grid){
	...
	var data = 
	{
		beginSjrq: beginSjrq,
		JLRQ : $('#JLRQ').val(),
		BSJRJGBM : $('#BSJRJGBM').val(),
		BSNBJGH : $('#BSNBJGH').val(),
		WDJRJGBM : $('#WDJRJGBM').val(),
		WDNBJGH : $('#WDNBJGH').val(),
		SFXJQSZX : $('#SFXJQSZX').val(),
		BXH : $('#BXH').val(),
		BZBS : $('#BZBS').val(),
		SBYWXLH : $('#SBYWXLH').val(),
		DRJRJGBM : $('#DRJRJGBM').val(),
		DRNBJGH : $('#DRNBJGH').val(),
...
//编辑保存
function saveData(){
	$('#UpdateSqlId').val("khdkUpdateData");
	$('#fm').form('submit', {  
