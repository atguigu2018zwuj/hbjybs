...
//		});
		...
		wdatePickerYMD("HTKSSJ");
		wdatePickerYMD("HTJSSJ");
		wdatePickerYMD("XG_SJRQ");
		wdatePickerYMD("XG_HTKSSJ");
		wdatePickerYMD("XG_HTJSSJ");
...
function doSearch(grid){
	...
	var data = 
	{
		...
		beginSjrq: beginSjrq,
		WBFWJRJGBM : $('#WBFWJRJGBM').val(),
		WBFWNBJGH : $('#WBFWNBJGH').val(),
		XJCLWBS : $('#XJCLWBS').val(),
		WBFWTYSHXYDM : $('#WBFWTYSHXYDM').val(),
		HTKSSJ : $('#HTKSSJ').val(),
		HTJSSJ: $('#HTJSSJ').val(),
...
//编辑保存
function saveData(){
	$('#UpdateSqlId').val("xjwbUpdateData");
	$('#fm').form('submit', {  
