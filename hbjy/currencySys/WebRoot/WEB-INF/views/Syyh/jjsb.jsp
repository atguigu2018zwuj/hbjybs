...
<html lang="en">
<head>
    <title>银行业金融机构在用机具设备情况调查表</title>
	...
	<div class="consult common" id="sssss">
		...
		<input type="hidden" value="<%=basePath %>" id="url">
				...
				<div class="accurateSearchInputs">
					<form id="formSub">
						<ul>
							...
							<li><span>清分设备生产厂家名称</span><input type="text" id="SBSCCJ" name="SBSCCJ" placeholder="支持模糊查询"/></li>
							<li><span>设备品牌</span><input type="text" id="SBPP" name="SBPP" placeholder="支持模糊查询"/></li>
							<li><span>产品种类</span><input type="text" id="CPZL" name="CPZL" placeholder="支持模糊查询"/></li>
							...
							<li><span><input type="hidden" id="excelSqlid" name="excelSqlid" value="getJjsbData"/></span></li>
						</ul>
					</form>
				...
				<div class="consult-right" style="margin-right: -5px;">
					<div class="consult-history" style="padding-bottom: 50px;">
						<div class="consult-head">
							<span class="consult-title">搜索结果-银行业金融机构在用机具设备情况调查表		(全量表-年报)</span>
						</div>
						<div class="" id="myTable" style="display:none;">
							<!-- 引入通用页面 -->
				            <jsp:include page="../currencyJsp/content.jsp">
				            	<jsp:param value="jjsb" name="str"/>
				            	<jsp:param value="SYYH_JJSB" name="tablename"/>
				            </jsp:include>
						</div>
					</div>
				</div>
			...
			<script type="text/javascript">
		    	seajs.use('myJsPath/js/Syyh/jjsb');
		    </script>
		</div>
</body>
</html>