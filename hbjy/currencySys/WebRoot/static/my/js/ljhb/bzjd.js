...
function doSearch(grid){
	...
	var data = 
	{
		...
		DYLX : $('#DYLX').val(),
		QB : $('#QB').val(),
		QSYDW_YLT_H : $('#QSYDW_YLT_H').val(),
		QSYDW_YLT_JH : $('#QSYDW_YLT_JH').val(),
		QSYDW_BYLT_C : $('#QSYDW_BYLT_C').val(),
		QSYDW_BYLT_JC : $('#QSYDW_BYLT_JC').val(),
		JRJG_YLT_H : $('#JRJG_YLT_H').val(),
		JRJG_YLT_JH : $('#JRJG_YLT_JH').val(),
		JRJG_BYLT_C : $('#JRJG_BYLT_C').val(),
		JRJG_BYLT_JC : $('#JRJG_BYLT_JC').val(),
		SBLX : $('#SBLX').val(),
...
function saveData(){
	...
	$('#UpdateSqlId').val("bzjdUpdateData");
	$('#fm').form('submit', {  
