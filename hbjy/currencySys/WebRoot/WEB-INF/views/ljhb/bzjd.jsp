	...
	<div class="consult common" id="sssss">
		...
		<input type="hidden" value="<%=basePath %>" id="url">
				...
				<div class="accurateSearchInputs">
					<form id="formSub">
						<ul>
							...
							<li><span>地域类型</span>
							<select id="DYLX"  name="DYLX" class="organizationSelect rightSelect">
							...
							<li><span>企事业单位-宜流通-好</span><input type="text" id="QSYDW_YLT_H" name="QSYDW_YLT_H" placeholder="支持模糊查询"/></li>
							<li><span>企事业单位-宜流通-较好</span><input type="text" id="QSYDW_YLT_JH" name="QSYDW_YLT_JH" placeholder="支持模糊查询"/></li>
							<li><span>企事业单位-不宜流通-差</span><input type="text" id="QSYDW_BYLT_C" name="QSYDW_BYLT_C" placeholder="支持模糊查询"/></li>
							<li><span>企事业单位-不宜流通-较差</span><input type="text" id="QSYDW_BYLT_JC" name="QSYDW_BYLT_JC" placeholder="支持模糊查询"/></li>
							<li><span>金融机构-宜流通-好</span><input type="text" id="JRJG_YLT_H" name="JRJG_YLT_H" placeholder="支持模糊查询"/></li>
							<li><span>金融机构-宜流通-较好</span><input type="text" id="JRJG_YLT_JH" name="JRJG_YLT_JH" placeholder="支持模糊查询"/></li>
							<li><span>金融机构-不宜流通-差</span><input type="text" id="JRJG_BYLT_C" name="JRJG_BYLT_C" placeholder="支持模糊查询"/></li>
							<li><span>金融机构-不宜流通-较差</span><input type="text" id="JRJG_BYLT_JC" name="JRJG_BYLT_JC" placeholder="支持模糊查询"/></li>
							...
							<li><span><input type="hidden" id="excelSqlid" name="excelSqlid" value="getBzjdData"/></span></li>
				...
				<div class="consult-right" style="margin-right: -5px;">
					<div class="consult-history" style="padding-bottom: 50px;">
						<div class="consult-head">
							<span class="consult-title">搜索结果-流通人民币整洁度状况调查表  (半年报-全量表)</span>
						</div>
						<div class="" id="myTable" style="display:none;">
							<!-- 引入通用页面 -->
				            <jsp:include page="../currencyJsp/content.jsp">
				            	<jsp:param value="bzjd" name="str"/>
				            	<jsp:param value="SYYH_BZJD" name="tablename"/>
				            </jsp:include>
						</div>
					</div>
				</div>
			...
			<script type="text/javascript">
		    	seajs.use('myJsPath/js/ljhb/bzjd');
		    </script>
		</div>
</body>
</html>