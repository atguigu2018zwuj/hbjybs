...
function doSearch(grid){
	...
	var data = 
	{
		...
		JRJGBM : $('#JRJGBM').val(),
		NBJGH : $('#NBJGH').val(),
		QFFS_ZXCL : $('#QFFS_ZXCL').val(),
		QFFS_ZCS : $('#QFFS_ZCS').val(),
		QFFS_LCS : $('#QFFS_LCS').val(),
		QFFS_JZQF : $('#QFFS_JZQF').val(),
		QFFS_FSQF : $('#QFFS_FSQF').val(),
		YBCL : $('#YBCL').val(),
		SBLX : $('#SBLX').val(),
...
function saveData(){
	...
	$('#UpdateSqlId').val("xjclUpdateData");
	$('#fm').form('submit', {  
