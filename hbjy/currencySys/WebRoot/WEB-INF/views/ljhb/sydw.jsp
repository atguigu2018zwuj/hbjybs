	...
	<div class="consult common" id="sssss">
		...
		<input type="hidden" value="<%=basePath %>" id="url">
				...
				<div class="accurateSearchInputs">
					<form id="formSub">
						<ul>
							...
							<li><span>样本分类</span>
							<select id="YBFL"  name="YBFL" class="organizationSelect rightSelect">
	                        	<option selected value="" name="--请选择--">--请选择--</option>
	                        	<option value="A01">机关事业单位</option>
	                        	<option value="A02">工业企业</option>
	                        	<option value="A03">建筑业企业</option>
	                        	<option value="A04">交通运输及仓储业企业</option>
	                        	<option value="A05">邮电业企业</option>
	                        	<option value="A06">批发及零售企业</option>
	                        	<option value="A07">餐饮业企业</option>
	                        	<option value="A08">房地产企业</option>
	                        	<option value="A09">社会服务业</option>
	                    	</select>
							</li>
							<li><span>报告期内共调查企事业单位</span><input type="text" id="BGQ_QSYDW" name="BGQ_QSYDW" placeholder="支持模糊查询"/></li>
							...
							<li><span><input type="hidden" id="excelSqlid" name="excelSqlid" value="getSydwData"/></span></li>
				...
				<div class="consult-right" style="margin-right: -5px;">
					<div class="consult-history" style="padding-bottom: 50px;">
						<div class="consult-head">
							<span class="consult-title">搜索结果-企事业单位统计表  (半年报-全量表)</span>
						</div>
						<div class="" id="myTable" style="display:none;">
							<!-- 引入通用页面 -->
				            <jsp:include page="../currencyJsp/content.jsp">
				            	<jsp:param value="sydw" name="str"/>
				            	<jsp:param value="SYYH_SYDW" name="tablename"/>
				            </jsp:include>
						</div>
					</div>
				</div>
			...
			<script type="text/javascript">
		    	seajs.use('myJsPath/js/ljhb/sydw');
		    </script>
		</div>
</body>
</html>