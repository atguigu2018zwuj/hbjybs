...
<head>
    <title>郑州市银行业金融机构出入库业务登记表</title>
	...
	<div class="consult common" id="sssss">
		...
		<input type="hidden" value="<%=basePath %>" id="url">
				...
				<div class="accurateSearchInputs">
					<form id="formSub">
						<ul>
							...
							<li>
							<span>券别版本</span>
							<select id="QBBB"  name="QBBB" class="organizationSelect rightSelect">
		                        	<option selected value="" name="--请选择--">--请选择--</option>
							...
							<li><span><input type="hidden" id="excelSqlid" name="excelSqlid" value="getCrkbData"/></span></li>
						</ul>
					</form>
				...
				<div class="consult-right" style="margin-right: -5px;">
					<div class="consult-history" style="padding-bottom: 50px;">
						<div class="consult-head">
							<span class="consult-title">搜索结果-郑州市银行业金融机构出入库业务登记表		(增量表-月报)</span>
						</div>
						<div id="myTable" style="display:none;">
							<!-- 引入通用页面 -->
				            <jsp:include page="../currencyJsp/content.jsp">
				            	<jsp:param value="crkb" name="str"/>
				            	<jsp:param value="SYYH_CRKB" name="tablename"/>
				            </jsp:include>
						</div>
					</div>
				</div>
			...
			<script type="text/javascript">
		    	seajs.use('myJsPath/js/zhhb/crkb');
		    </script>
		</div>
</body>
</html>