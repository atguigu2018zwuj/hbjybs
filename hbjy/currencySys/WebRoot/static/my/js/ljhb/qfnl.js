...
function doSearch(grid){
	...
	var data = 
	{
		...
		NBJGH : $('#NBJGH').val(),
		WDZS : $('#WDZS').val(),
		WDQF_YPWD : $('#WDQF_YPWD').val(),
		WDQF_QFJPZ_ZB : $('#WDQF_QFJPZ_ZB').val(),
		WDQF_QFJPZ_YB : $('#WDQF_QFJPZ_YB').val(),
		JZQF_QFZX : $('#JZQF_QFZX').val(),
		JZQF_QFJPZ_ZB : $('#JZQF_QFJPZ_ZB').val(),
		JZQF_QFJPZ_YB : $('#JZQF_QFJPZ_YB').val(),
		YQFKS : $('#YQFKS').val(),
		SBLX : $('#SBLX').val(),
...
function saveData(){
	...
	$('#UpdateSqlId').val("qfnlUpdateData");
	$('#fm').form('submit', {  
