	...
	<div class="consult common" id="sssss">
		...
		<input type="hidden" value="<%=basePath %>" id="url">
				...
				<div class="accurateSearchInputs">
					<form id="formSub">
						<ul>
							...
							<li><span>单位名称</span>
							<input type="text" id="DWMC" name="DWMC" placeholder="支持模糊查询"/>
							...
							<li><span><input type="hidden" id="excelSqlid" name="excelSqlid" value="getJrtjData"/></span></li>
				...
				<div class="consult-right" style="margin-right: -5px;">
					<div class="consult-history" style="padding-bottom: 50px;">
						<div class="consult-head">
							<span class="consult-title">搜索结果-银行业金融机构对客户现金收支统计表  (季报表-增量表)</span>
						</div>
						<div class="" id="myTable" style="display:none;">
							<!-- 引入通用页面 -->
				            <jsp:include page="../currencyJsp/content.jsp">
				            	<jsp:param value="jrtj" name="str"/>
				            	<jsp:param value="SYYH_JRTJ" name="tablename"/>
				            </jsp:include>
						</div>
					</div>
				</div>
			...
			<script type="text/javascript">
		    	seajs.use('myJsPath/js/jrjg/jrtj');
		    </script>
		</div>
</body>
</html>