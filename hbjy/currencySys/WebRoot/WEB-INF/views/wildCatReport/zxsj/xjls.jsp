	...
	<div class="consult common" id="sssss">
		...
		<input type="hidden" value="<%=basePath %>" id="url">
				...
				<div class="accurateSearchInputs">
					<form id="formSub">
						<ul>
							...
							<li><span><input type="hidden" id="excelSqlid" name="excelSqlid" value="getXjlsData"/></span></li>
						</ul>
					</form>
				...
				<div class="consult-right" style="margin-right: -5px;">
					<div class="consult-history" style="padding-bottom: 50px;">
						<div class="consult-head">
							<span class="consult-title">搜索结果-金融机构现金流水明细表     (日报表-增量表)</span>
						</div>
						<div class="" id="myTable" style="display:none;">
							<!-- 引入通用页面 -->
				            <jsp:include page="../../currencyJsp/content.jsp">
				            	<jsp:param value="xjls" name="str"/>
				            	<jsp:param value="SPECIAL_XJLS" name="tablename"/>
				            </jsp:include>
						</div>
					</div>
				</div>
			...
			<script type="text/javascript">
		    	seajs.use('myJsPath/js/wildCatReport/zxsj/xjls');
		    </script>
		</div>
</body>
</html>