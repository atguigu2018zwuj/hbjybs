...
@Repository
public abstract class ImpalaBaseDao extends SqlSessionDaoSupport{
	
	@Autowired
	public void setSqlSessionFactory(@Qualifier(value="impalaSqlSessionFactory") SqlSessionFactory impalaSqlSessionFactory) {
		super.setSqlSessionFactory(impalaSqlSessionFactory);
	}
