	...
	<div class="consult common" id="sssss">
		...
		<input type="hidden" value="<%=basePath %>" id="url">
				...
				<div class="accurateSearchInputs">
					<form id="formSub">
						<ul>
							...
							<li><span><input type="hidden" id="excelSqlid" name="excelSqlid" value="getXqqkData"/></span></li>
						</ul>
					</form>
					...
					<div class="consult-history" style="padding-bottom: 50px;">
						...
						<div id="myTable" style="display:none;">
				            ...
				            <jsp:include page="../currencyJsp/content.jsp">
				            	<jsp:param value="xqqk" name="str"/>
				            	<jsp:param value="SYYH_XQQK" name="tablename"/>
				            </jsp:include>
						</div>
					</div>
				</div>
			...
			<script type="text/javascript">
		    	seajs.use('myJsPath/js/zhhb/xqqk');
		    </script>
		</div>
</body>
</html>