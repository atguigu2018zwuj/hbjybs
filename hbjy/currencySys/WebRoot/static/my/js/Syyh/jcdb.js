...
define(function(require) {
	...
	$(function() {
		...
		//开始时间
		wdatePickerYMD("SJRQ");
		wdatePickerYMD("JB_SJSJ");
		//收缴日期
		wdatePickerYMD("XG_JB_SJSJ");
		//数据日期
...
function doSearch(grid){
	...
	var data = 
	{
		...
		JB_GZH : $('#JB_GZH').val(),
		JB_LY : $('#JB_LY').val(),
		CBR_NAME : $('#CBR_NAME').val(),//持币人姓名
		CBR_ID : $('#CBR_ID').val(),//持币人身份证号
		SBLX : $('#sblx').val(),
...
function saveData(){
	...
	$('#UpdateSqlId').val("jcdbUpdateData");
	$('#fm').form('submit', {  
