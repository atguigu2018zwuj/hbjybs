...
function doSearch(grid){
	...
	var data = 
	{
		...
		JRJGBM : $('#JRJGBM').val(),
		NBJGH : $('#NBJGH').val(),
		QXYH_YYWD : $('#QXYH_YYWD').val(),
		CYYH_YYWD : $('#CYYH_YYWD').val(),
		QXYH_CYBL : $('#QXYH_CYBL').val(),
		QXYH_ZZJJ : $('#QXYH_ZZJJ').val(),
		CYYH_ZZJJ : $('#CYYH_ZZJJ').val(),
		QXYH_ZZCYBL : $('#QXYH_ZZCYBL').val(),
		QXYH_QFSB : $('#QXYH_QFSB').val(),
		QFZX_QFSB : $('#QFZX_QFSB').val(),
		YHWD_QFSB : $('#YHWD_QFSB').val(),
		SBLX : $('#SBLX').val(),
...
function saveData(){
	...
	$('#UpdateSqlId').val("wsslUpdateData");
	$('#fm').form('submit', {  
